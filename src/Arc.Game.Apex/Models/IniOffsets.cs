...
namespace Arc.Game.Apex.Models
{
    ...
    public class IniOffsets : IOffsets
    {
        ...
        public uint PlayerHealth => _ini.Get("RecvTable.DT_Player", "m_iHealth");
        public uint PlayerShields => _ini.Get("RecvTable.DT_BaseEntity", "m_shieldHealth");
        public uint PlayerShieldsMax => _ini.Get("RecvTable.DT_BaseEntity", "m_shieldHealthMax");
        public uint PlayerTeamNum => _ini.Get("RecvTable.DT_BaseEntity", "m_iTeamNum");
        public uint SelectedWeapons => _ini.Get("DataMap.C_BaseCombatCharacter", "m_latestPrimaryWeapons");
